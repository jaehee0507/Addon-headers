...
class Tile {
    ...
    virtual void isCropTile() const;
    virtual void isContainerTile() const;
    virtual void isCraftingTile() const;
    virtual void isInteractiveTile() const;
    virtual void isPathfindable(Entity*, TilePos const&, int, int, int);
    virtual void mayPick();
    virtual void mayPick(TileSource*, int, bool);
    ...
    virtual void isSeasonTinted(TileSource*, TilePos const&) const;
    ...
    virtual void getName(ItemInstance const*) const;
    ...
    virtual void init();
    virtual void _canBeSilkTouched() const;
    virtual void getSilkTouchItemInstance(int);
    ...
    static void getTileMaterial(int);
    static void initTiles();
    static void isFaceVisible(TileSource*, int, int, int, signed char);
    void isLiquidTile() const;
    void isObstructingChests(TileSource*, TilePos const&);
    static void isTileType(FullTile const&, TileType);
